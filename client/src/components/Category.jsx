            ...
            <div>
                ...
                <div className="grid md:grid-cols-9 grid-cols-3 md:mt-3 mt-6 max-md:max-w-full ml-[2.49rem]">
                    {Categories.map((category) => (
                        <Link to={`/college/${category.title}`} className="cursor-default">
                            <div key={category} className="bg-black mt-3 font-[1000] md:w-[72%] w-[87%] hover:bg-blue-500 md:py-8 py-8 md:text-2xl text-md border-[1px] border-blue-500 rounded-full">
