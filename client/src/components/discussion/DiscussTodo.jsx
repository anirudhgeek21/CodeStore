            ...
            <div className="flex flex-col items-center justify-center h-[33vh]">
                <form className="border-blue-600 border-[1px] shadow-md rounded-lg p-6 md:w-[40%] w-[90%]">
                    ...
                    <div className="text-center">
                        <button type="submit" className="bg-blue-500 hover:bg-blue-400 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Start Now</button>
                    </div>
                </form>
            </div>
        </Fragment>
